...
?>
    <div id="wrapper">
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Ödünç Kitaplar</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            if(isset($_SESSION['islemid'])){
                ...
                <table class="table table-responsive table-stripped table-bordered">
                    <tr><th>Resim</th><th>ID</th><th>Kitap adı</th><th>ISBN</th><th>Kimde</th><th>TC</th><th>Ünvan</th><th>Tel</th><th>Verilen T.</th><th>Dönecek T.</th><th>Teslim T.</th></tr>
                    <?php $kitapislemleri = $run->disaridaki(); 
                        ...
                        <form class="form-horizontal" enctype="multipart/form-data" name="kitapform" id="kitapform" action="" method="POST">
                            ...
                            if($row['gelecektar'] < date('Y-m-d') && $row['alinistar'] == NULL)
                                ...
                                <td><?php echo $run->kitapget($kitapid)->id; ?></td>
