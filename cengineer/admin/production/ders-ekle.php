                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form action="../connect/islem.php" method="POST" id="demo-form2" data-parsley-validate
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="first-name" name="ders_ad"
                                           placeholder="Ders İçerik Başlığını (Adını Giriniz)" required="required"
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Ders keyword
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="first-name" name="ders_keyword"
                                           placeholder="DErs için anahtar kelimeler giriniz." class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="first-name" name="ders_url"
                                           placeholder="Eklediğiniz içeriğin görüntüleneceği kısmı giriniz"
                                           class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="first-name" name="ders_sira"
                                           placeholder="Ders Sırasını Giriniz"
                                           class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                    <button type="submit" name="dersekle" class="btn btn-success">Kaydet
                                    </button>
                                </div>
                            </div>
