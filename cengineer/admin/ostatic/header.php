...
$durum=$kullanicicek['kullanici_durum'];

$say=$kullanicisor->rowCount();
if($say==0 || $yetki!=5 || $durum !=1){
    header("Location:../production/login.php?durum=izinsizgiris");
    exit;
}
...
<head>
    ...
    <title>Cengineer | Yönetim Paneli</title>
        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="index.php" class="site_title"><i class="fa fa-paw"></i> <span><?php echo $ayarcek['ayar_sitelogoisim']?></span></a>
                </div>
                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a href="hakkimda.php"><i class="fa fa-info"></i> Hakkımda </a></li>
                            <li><a href="kullanici.php"><i class="fa fa-users"></i> Kullanıcılar </a></li>
                            <li><a href="menu.php"><i class="fa fa-bars"></i> Menüler </a></li>
                            <li><a href="kategori.php"><i class="fa fa-tags"></i> Dersler </a></li>
                            <li><a href="ders.php"><i class="fa fa-book"></i> Ders İçerikleri </a></li>
                        </ul>
                    </div>
                </div>
                <!-- /sidebar menu -->
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="">
                            ...
                            <ul class="dropdown-menu dropdown-usermenu pull-right">
                                <li><a href="../production/admin-hesap.php"> Profil Bilgilerim</a></li>
