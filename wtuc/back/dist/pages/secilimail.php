...
//    $mail->SMTPDebug = 2;
    ...
    if ($mail->send()) {
       ...
       // require_once "front-end/controller/IletisimController.php";
        ...
        $gittiMail = "<br><p class='bg-success'>Sayın $kime, mesajınız gönderildi...</p>";
    } else {
...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="fa fa-envelope-o"></i>&nbsp;<?= $secilimail['adSoyad'] ?> Kişisinden Gelen Mail</h1>
        </div>
    </div>
    ...
    <div class="row user">
                    ...
                    <div class="timeline-post">
                        <div class="post-media"><a href="#"></a>
                            <div class="content">
                                ...
                                <p class="text-muted"><small><?= date("d/m/Y H:m:s", strtotime($secilimail['tarih'])) ?></small></p>
                            </div>
                        </div>
        ...
        <div class="col-md-12">
            <form action="mail-<?= seo($secilimail['id']) ?>" method="POST">
                <div class="collapse" id="yanitla">
                    ...
                    <div class="card card-body">
                        ...
                        <input type="hidden" name="ad_soyad" value="<?= $secilimail['ad_soyad'] ?>">
