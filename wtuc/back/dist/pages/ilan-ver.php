...
if (!$yetkiler['ilan-ver']['sayfa_goruntuleme']) {
...
<?php } ?>
    ...
    <main class="app-content">
        ...
        <div class="row tile">
            <div class="col-md-12">
                <?php if ($yetkiler['ilan-ver']['ekleme']) { ?>
            ...
            <div class="col-md-12">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade active show table-responsive" id="guncel">
                            ...
                            <?php foreach ($guncelilanlar as $ilan) {
                                ...
                                if ($ilan['son_basvuru_tarih'] >= $bugunun_tarihi->format("Y-m-d")) { ?>
                                    <tr>
                                        ...
                                        <td><?= date("d/m/Y", strtotime($ilan['tarih'])) ?></td>
                                        <td><?= date("d/m/Y", strtotime($ilan['son_basvuru_tarih'])) ?></td>
                                        <td>
                                            <center>
                                                <div class="toggle lg">
                                                    <label>
                    ...
                    <div class="tab-pane fade  table-responsive" id="dolan">
                        <table class="table table-striped">
                            <thead>
                            <tr>
                                <th>#</th>
                                ...
                                <th>Son Başvuru Tarihi</th>
                                <th>Durum</th>
                                <?php if ($yetkiler['ilan-ver']['sayfa_goruntuleme']) { ?>
