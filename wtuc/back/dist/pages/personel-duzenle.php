...
if (isset($_POST['genel_kaydet'])) {
    ...
    if ($_POST['d_tarih'] > $bugunun_tarihi->format("Y-m-d")) {
        array_push($error, "Doğum Tarihi Bugünden Büyük Olamaz");
    } else {
        $d_tarih = $_POST['d_tarih'];
    }
    if ($_POST['baslama_tarihi'] > $bugunun_tarihi->format("Y-m-d")) {
        array_push($error, "İşe Başlama Tarihi Bugünden Büyük Olamaz");
    } else {
                        ...
                        <table class="table table-striped table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <?php foreach ($projeler as $proje) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <center> <?php if ($proje['bitis_tarih']<$bugunun_tarihi->format("Y-m-d")) {
                                            echo "Proje Devam Ediyor";
                                            }else{
                                                echo "Proje Bitti";
                                            }?></center>
                                    </td>
                                    <td>
                                        <center>
                                            <?php if ($yetkiler['personeller']['projeler']) { ?>
                                                <?php if ($proje['bitis_tarih']<$bugunun_tarihi->format("Y-m-d")) { ?>
